import type { DocMedia, DocSection } from './docTypes'

export type { DocMedia, DocSection, DocStatus } from './docTypes'
...
const publicDocs: Omit<DocSection, 'access'>[] = [
  {
...
/** Publicly readable docs, bundled into the client. */
export const docs: DocSection[] = publicDocs.map((doc) => ({
  ...doc,
